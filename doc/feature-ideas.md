...
- [ ] **メッセージ転送** — 投稿内容を別チャンネルやDMへ引用付きで転送する｜難易度: 中
- [ ] **会話イベント投稿** — 日時付きの告知を投稿し、参加可否を集められる｜難易度: 中
...
- [ ] **予約送信** — メッセージを指定時刻に自動投稿する｜難易度: 中
- [ ] **メッセージ編集履歴** — 編集前の内容や更新時刻を後から確認できる｜難易度: 中
- [ ] **メッセージテンプレート / 定型文** — よく使う文面をショートカットで挿入する｜難易度: 低
...
- [ ] **投稿権限制御チャンネル** — 閲覧専用や管理者のみ投稿可のチャンネルを作れる｜難易度: 中
- [ ] **ワークスペース初回オンボーディング** — 初回ログイン時におすすめチャンネルや使い方を案内する｜難易度: 低
...
- [ ] **タグ機能** — メッセージやチャンネルに任意タグを付けて整理する｜難易度: 中
...
- [ ] **通報 / モデレーションキュー** — 不適切な投稿を報告し、管理者がレビューできる｜難易度: 中
- [ ] **NGワード / 添付制限** — 特定表現や危険なファイル種別を事前ブロックする｜難易度: 中
- [ ] **監査ログのエクスポート** — CSV等で監査ログを外部提出用に出力する｜難易度: 低
